...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1832275376571014326L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"org.wanwanframework.avro\",\"doc\":\"A pair of strings\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
   ...
   */
  public static org.wanwanframework.avro.StringPair.Builder newBuilder() {
    return new org.wanwanframework.avro.StringPair.Builder();
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static org.wanwanframework.avro.StringPair.Builder newBuilder(org.wanwanframework.avro.StringPair.Builder other) {
    return new org.wanwanframework.avro.StringPair.Builder(other);
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static org.wanwanframework.avro.StringPair.Builder newBuilder(org.wanwanframework.avro.StringPair other) {
    return new org.wanwanframework.avro.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.wanwanframework.avro.StringPair.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.wanwanframework.avro.StringPair other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.wanwanframework.avro.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.wanwanframework.avro.StringPair.Builder clearLeft() {
      left = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.wanwanframework.avro.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.wanwanframework.avro.StringPair.Builder clearRight() {
      right = null;
